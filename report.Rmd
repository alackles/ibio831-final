...
```{r}
null.model <- glm(cancer.counts ~ mass, family=poisson)
no.interaction.model <- glm(cancer.counts ~ genA + genB + mass, family=poisson)
interaction.model <- glm(cancer.counts ~ genA*genB + mass, family=poisson)
