...
The presence of gene A leads to 16% less change in lifetime cancer risk compared to presence of gene B under the interaction model for cats that are 10 to 11 lbs.

The presence of both genes A and B leads to 33% less change in lifetime cancer risk compared to presence of gene A under the interaction model for cats that are 10 to 11 lbs.

The presence of both gene A and B leads to 44% less change in lifetime cancer risk compared to presence of gene B under the interaction model for cats that are 10 to 11 lbs.
