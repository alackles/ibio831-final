...
p_null <- inv.logit(null.model$coefficients[["(Intercept)"]] + 
...
genA_div_genB <- genA/genB
genA_div_genB - 1     # 0.08621106
# Presence of Gene A leads to 8.62% greater change in lifetime cancer risk compared to presence of Gene B under the interaction.model for cats that are 10 to 11 lb mass.

genAB_div_genA <- genAB/genA
genAB_div_genA - 1    # -0.3018433
# Presence of both Gene A and B leads to 30.18% decrease change in lifetime cancer risk compared to presence of Gene A under the interaction.model for cats that are 10 to 11 lb mass.

genAB_div_genB <- genAB/genB
genAB_div_genB - 1    # -0.2416545
# Presence of both Gene A and B leads to 24.17% decrease change in lifetime cancer risk compared to presence of Gene B under the interaction.model for cats that are 10 to 11 lb mass.
