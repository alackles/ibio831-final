...
```{r}
null.model <- glm(cancer.counts ~ genA + genB + mass, family=poisson)
ab.model <- glm(cancer.counts ~ genA*genB + mass, family=poisson)
amass.model <- glm(cancer.counts ~ genA*mass + genB, family=poisson)
bmass.model <- glm(cancer.counts ~ genB*mass +genA, family=poisson)
full.model <- glm(cancer.counts ~ genA*genB*mass, family=poisson)
```
---
## Statistical Test
