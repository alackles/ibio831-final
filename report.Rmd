...
mass.model <- glm(cancer.prop ~ mass.scaled, data=cancer.table,binomial(link="logit"))
no.interaction.model <- glm(cancer.prop  ~ genA + genB + mass.scaled, data=cancer.table,binomial(link="logit"))
interaction.model <- glm(cancer.prop  ~ genA*genB + mass.scaled, data=cancer.table,binomial(link="logit"))
summary(null.model)
summary(mass.model)
